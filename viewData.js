...
const createInnerHtml = () => {
    ...
    <td>
        <img id="${empPayrollData._id}" onclick="remove(this)" alt="delete" src="7.png" width="30px">
        <a href="Employee.html" onclick="update(this)"><img id="${empPayrollData._id}" onclick="update(this)" alt="edit" src="8.png" width="30px"></a>
    </td>
</tr>
`;
    }
